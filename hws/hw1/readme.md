...
+ Изучите флеш-память.
  ...
  ```
  В конце имени файла указано расширение .bin. 
...
![alt-текст](https://github.com/gridrav/homework_otus/blob/main/hws/hw1/Screens/ip.png?raw=true)
...
```
Выполним команду show interface vlan 1 для проверки параметров VLAN 1
...
Vlan1 is up, line protocol is up
  ...
  5 minute output rate 0 bits/sec, 0 packets/sec
     ...
     0 output buffer failures, 0 output buffers swapped out
```
Полоса пропускания этого интерфейса 100000 Kbit
